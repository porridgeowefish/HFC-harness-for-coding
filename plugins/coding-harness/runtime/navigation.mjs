...
const PURPOSES = {
  ...
  'business-knowledge-writer.md': '初始化业务知识 Agent 的写入范围与交接边界',
  'engineering-knowledge-writer.md': '初始化工程知识 Agent 的写入范围与交接边界',
  'rules-writer.md': '初始化 Rules Agent 的写入范围与交接边界',
